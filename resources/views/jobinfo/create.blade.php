<x-app-layout>
    <body>
        ...
        <form action="/submit" method="post">
            ...
            <label for="job_title"><p class="input_distance">Job Title:</p></label>
            <input type="text" name="job_title" id="job_title" class="input-style" required>

            <label for="company"><p class="input_distance">Company:</p></label>
            <input type="text" name="company" id="company" class="input-style" required>
            ...
            <input type="text" name="job_location" id="job_location" class="input-style" required>
