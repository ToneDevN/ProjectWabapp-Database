    ...
    document.getElementById('dropzone-file').addEventListener('change', function(event) {
        ...
        if (fileInput.files.length > 0) {
            ...
            if (fileSize > maxSize) {
                ...
                document.getElementById('selected-file-name').textContent = 'Selected File: ' + fileInput.files[
                    0].name;
            }
        }
    });
        ...
        <div class="container">
            ...
            <div class="user-info" style="margin-bottom: 20px;">
                <div class="profile-image-container">
                    <img src="{{ asset('profile/' . $user->idUser . '.jpg') }}" alt="You didn't Set Proflie"
                        class="profile-image">
                </div>
            ...
            <!-- Profile Form -->
            <form action="{{ route('ansQuestioner') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <span id="selected-file-name" class="text-sm text-gray-500 dark:text-gray-400"></span>
                            <!-- Add this line to display selected file name -->
                        </div>
                        <input id="dropzone-file" name="resume" type="file" class="hidden" accept=".pdf"
                            required />
                    </label>
                </div>
